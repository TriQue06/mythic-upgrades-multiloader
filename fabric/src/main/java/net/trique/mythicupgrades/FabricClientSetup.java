...
public class FabricClientSetup implements ClientModInitializer {
    ...
    private static void registerCutoutRenderLayers() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MythicBlocks.KYANITE_CRYSTAL_CLUSTER,     cutout);
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MythicBlocks.LARGE_KYANITE_CRYSTAL_BUD,     cutout);
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MythicBlocks.MEDIUM_KYANITE_CRYSTAL_BUD,     cutout);
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(MythicBlocks.SMALL_KYANITE_CRYSTAL_BUD,     cutout);
