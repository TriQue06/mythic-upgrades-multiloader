...
public class MythicUpgradeTemplateItem extends SmithingTemplateItem {
    ...
    private static final String DESC_ID = Util.makeDescriptionId("item",
            new ResourceLocation(Constants.MOD_ID, "mythic_upgrade_smithing_template"));

    private static final Component APPLIES_TO = Component.translatable(
            Util.makeDescriptionId("item", new ResourceLocation(Constants.MOD_ID, "mythic_upgrade_smithing_template.applies_to")))
            .withStyle(ChatFormatting.BLUE);
    private static final Component INGREDIENTS = Component.translatable(
            Util.makeDescriptionId("item", new ResourceLocation(Constants.MOD_ID, "mythic_upgrade_smithing_template.ingredients")))
            .withStyle(ChatFormatting.BLUE);
    private static final Component TITLE = Component.translatable(
            Util.makeDescriptionId("upgrade", new ResourceLocation(Constants.MOD_ID, "mythic_upgrade")))
            .withStyle(ChatFormatting.GRAY);
    private static final Component BASE_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", new ResourceLocation(Constants.MOD_ID, "mythic_upgrade_smithing_template.base_slot_description")));
    private static final Component ADDITIONS_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", new ResourceLocation(Constants.MOD_ID, "mythic_upgrade_smithing_template.additions_slot_description")));
