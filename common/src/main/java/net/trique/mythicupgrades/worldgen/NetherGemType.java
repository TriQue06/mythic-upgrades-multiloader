...
public enum NetherGemType {
    ...
    public ResourceKey<ConfiguredFeature<?, ?>> crystalBlobsCF()    { return cf(id + "_rift_crystal_blobs"); }
    public ResourceKey<ConfiguredFeature<?, ?>> crystalBudsCF()     { return cf(id + "_rift_crystal_buds"); }
    public ResourceKey<ConfiguredFeature<?, ?>> crystalBudsRareCF() { return cf(id + "_rift_crystal_buds_rare"); }
    public ResourceKey<ConfiguredFeature<?, ?>> oreCF()             { return cf(id + "_rift_ore"); }
    ...
    public ResourceKey<PlacedFeature> crystalBlobsPF()    { return pf(id + "_rift_crystal_blobs"); }
    public ResourceKey<PlacedFeature> crystalBudsPF()     { return pf(id + "_rift_crystal_buds"); }
    public ResourceKey<PlacedFeature> crystalBudsRarePF() { return pf(id + "_rift_crystal_buds_rare"); }
    public ResourceKey<PlacedFeature> orePF()             { return pf(id + "_rift_ore"); }
    public ResourceKey<PlacedFeature> geodePF()           { return pf(id + "_rift_geode"); }
