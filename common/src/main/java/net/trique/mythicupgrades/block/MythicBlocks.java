...
public class MythicBlocks {
    ...
    public static final Block AQUAMARINE_ORE = defer("aquamarine_ore", new DropExperienceBlock(
        UniformInt.of(6, 14),
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_ORE).mapColor(MapColor.STONE).strength(3.0F, 3.0F)));

    public static final Block DEEPSLATE_AQUAMARINE_ORE = defer("deepslate_aquamarine_ore", new DropExperienceBlock(
        UniformInt.of(6, 14),
        BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_DIAMOND_ORE).mapColor(MapColor.DEEPSLATE).strength(4.5F, 3.0F)));
    ...
    public static final Block RUBY_ORE = defer("ruby_ore", new DropExperienceBlock(
        UniformInt.of(4, 10),
        BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_GOLD_ORE).mapColor(MapColor.NETHER).strength(3.0F, 3.0F)));
    ...
    public static final Block RAW_NECOIUM_BLOCK = defer("raw_necoium_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.RAW_GOLD_BLOCK).mapColor(MapColor.WARPED_NYLIUM).strength(5.0F, 6.0F)));

    public static final Block AQUAMARINE_BLOCK = defer("aquamarine_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).strength(5.0F, 6.0F)));

    public static final Block CITRINE_BLOCK = defer("citrine_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_YELLOW).strength(5.0F, 6.0F)));

    public static final Block TOPAZ_BLOCK = defer("topaz_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_ORANGE).strength(5.0F, 6.0F)));

    public static final Block PERIDOT_BLOCK = defer("peridot_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_LIGHT_GREEN).strength(5.0F, 6.0F)));

    public static final Block RUBY_BLOCK = defer("ruby_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_RED).strength(5.0F, 6.0F)));

    public static final Block SAPPHIRE_BLOCK = defer("sapphire_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.LAPIS).strength(5.0F, 6.0F)));

    public static final Block JADE_BLOCK = defer("jade_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.PLANT).strength(5.0F, 6.0F)));

    public static final Block AMETRINE_BLOCK = defer("ametrine_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.COLOR_PURPLE).strength(5.0F, 6.0F)));

    public static final Block NECOIUM_BLOCK = defer("necoium_block", new Block(
        BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK).mapColor(MapColor.WARPED_NYLIUM).strength(5.0F, 6.0F)));
    ...
    public static final Block AQUAMARINE_CRYSTAL_CLUSTER = defer("aquamarine_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_LIGHT_BLUE)));
    public static final Block LARGE_AQUAMARINE_CRYSTAL_BUD = defer("large_aquamarine_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_LIGHT_BLUE)));
    public static final Block MEDIUM_AQUAMARINE_CRYSTAL_BUD = defer("medium_aquamarine_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_LIGHT_BLUE)));
    public static final Block SMALL_AQUAMARINE_CRYSTAL_BUD = defer("small_aquamarine_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_LIGHT_BLUE)));
    ...
    public static final Block CITRINE_CRYSTAL_CLUSTER = defer("citrine_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_YELLOW)));
    public static final Block LARGE_CITRINE_CRYSTAL_BUD = defer("large_citrine_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_YELLOW)));
    public static final Block MEDIUM_CITRINE_CRYSTAL_BUD = defer("medium_citrine_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_YELLOW)));
    public static final Block SMALL_CITRINE_CRYSTAL_BUD = defer("small_citrine_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_YELLOW)));
    public static final Block BUDDING_CITRINE_CRYSTAL = defer("budding_citrine_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.COLOR_YELLOW)));
    ...
    public static final Block TOPAZ_CRYSTAL_CLUSTER = defer("topaz_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_ORANGE)));
    public static final Block LARGE_TOPAZ_CRYSTAL_BUD = defer("large_topaz_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_ORANGE)));
    public static final Block MEDIUM_TOPAZ_CRYSTAL_BUD = defer("medium_topaz_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_ORANGE)));
    public static final Block SMALL_TOPAZ_CRYSTAL_BUD = defer("small_topaz_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_ORANGE)));
    public static final Block BUDDING_TOPAZ_CRYSTAL = defer("budding_topaz_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.COLOR_ORANGE)));
    ...
    public static final Block PERIDOT_CRYSTAL_CLUSTER = defer("peridot_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final Block LARGE_PERIDOT_CRYSTAL_BUD = defer("large_peridot_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final Block MEDIUM_PERIDOT_CRYSTAL_BUD = defer("medium_peridot_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final Block SMALL_PERIDOT_CRYSTAL_BUD = defer("small_peridot_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final Block BUDDING_PERIDOT_CRYSTAL = defer("budding_peridot_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    ...
    public static final Block RUBY_CRYSTAL_CLUSTER = defer("ruby_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_RED)));
    public static final Block LARGE_RUBY_CRYSTAL_BUD = defer("large_ruby_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_RED)));
    public static final Block MEDIUM_RUBY_CRYSTAL_BUD = defer("medium_ruby_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_RED)));
    public static final Block SMALL_RUBY_CRYSTAL_BUD = defer("small_ruby_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_RED)));
    public static final Block BUDDING_RUBY_CRYSTAL = defer("budding_ruby_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.COLOR_RED)));
    ...
    public static final Block SAPPHIRE_CRYSTAL_CLUSTER = defer("sapphire_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.LAPIS)));
    public static final Block LARGE_SAPPHIRE_CRYSTAL_BUD = defer("large_sapphire_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.LAPIS)));
    public static final Block MEDIUM_SAPPHIRE_CRYSTAL_BUD = defer("medium_sapphire_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.LAPIS)));
    public static final Block SMALL_SAPPHIRE_CRYSTAL_BUD = defer("small_sapphire_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.LAPIS)));
    public static final Block BUDDING_SAPPHIRE_CRYSTAL = defer("budding_sapphire_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.LAPIS)));
    ...
    public static final Block JADE_CRYSTAL_CLUSTER = defer("jade_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.PLANT)));
    public static final Block LARGE_JADE_CRYSTAL_BUD = defer("large_jade_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.PLANT)));
    public static final Block MEDIUM_JADE_CRYSTAL_BUD = defer("medium_jade_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.PLANT)));
    public static final Block SMALL_JADE_CRYSTAL_BUD = defer("small_jade_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.PLANT)));
    public static final Block BUDDING_JADE_CRYSTAL = defer("budding_jade_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.PLANT)));
    ...
    public static final Block AMETRINE_CRYSTAL_CLUSTER = defer("ametrine_crystal_cluster", new AmethystClusterBlock(7, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER).lightLevel(state -> 6).mapColor(MapColor.COLOR_PURPLE)));
    public static final Block LARGE_AMETRINE_CRYSTAL_BUD = defer("large_ametrine_crystal_bud", new AmethystClusterBlock(5, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD).lightLevel(state -> 5).mapColor(MapColor.COLOR_PURPLE)));
    public static final Block MEDIUM_AMETRINE_CRYSTAL_BUD = defer("medium_ametrine_crystal_bud", new AmethystClusterBlock(4, 3,
        BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD).lightLevel(state -> 3).mapColor(MapColor.COLOR_PURPLE)));
    public static final Block SMALL_AMETRINE_CRYSTAL_BUD = defer("small_ametrine_crystal_bud", new AmethystClusterBlock(3, 4,
        BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD).lightLevel(state -> 2).mapColor(MapColor.COLOR_PURPLE)));
    public static final Block BUDDING_AMETRINE_CRYSTAL = defer("budding_ametrine_crystal", new MythicBuddingCrystalBlock(
        ...
        BlockBehaviour.Properties.ofFullCopy(Blocks.BUDDING_AMETHYST).mapColor(MapColor.COLOR_PURPLE)));
