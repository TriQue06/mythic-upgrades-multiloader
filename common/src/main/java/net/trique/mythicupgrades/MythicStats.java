...
public class MythicStats {
    ...
    public static int TOPAZ_TOOL_SHOCK_INTERVAL = 5;
    ...
    public static float RUBY_TOOL_LIFESTEAL_FRACTION = 0.10f;
    public static int RUBY_TOOL_LIFESTEAL_PARTICLE_COUNT = 15;
